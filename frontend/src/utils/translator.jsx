...
export const AutoTranslate = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Define custom properties / methods
    if (nodeValueDescriptor) {
    ...
    // Translate existing DOM elements initially
    ...
    return () => {
      if (nodeValueDescriptor) Object.defineProperty(Node.prototype, 'nodeValue', nodeValueDescriptor);
      if (textContentDescriptor) Object.defineProperty(Node.prototype, 'textContent', textContentDescriptor);
